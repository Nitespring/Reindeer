...
public class CustomDataTickets  {
    ...
    public static final DataTicket<Integer> COLOUR = DataTicket.create("colour", Integer.class);
    ...
    public static final DataTicket<Boolean> HAS_CHEST = DataTicket.create("has_chest", Boolean.class);
    public static final DataTicket<Boolean> HAS_PASSENGER = DataTicket.create("has_passenger", Boolean.class);
