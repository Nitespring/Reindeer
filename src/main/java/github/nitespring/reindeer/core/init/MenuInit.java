...
public class MenuInit{
    ...
    public static final DeferredHolder<MenuType<?>,MenuType<ReindeerInventoryMenu>> REINDEER_INVENTORY_MENU = MENUS.register("reindeer_inventory_menu", () -> new MenuType<>(ReindeerInventoryMenu::new, FeatureFlags.DEFAULT_FLAGS));
